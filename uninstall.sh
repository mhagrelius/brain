...
# ordinary files in a folder you chose, and they are not Brain's to delete.
#
set -euo pipefail
...
say "Removing Brain from $PREFIX"
...
echo
say "Done. Your notes and ~/.config/brain/config.json were left alone."
say "Remove the config with: rm -r ~/.config/brain"
